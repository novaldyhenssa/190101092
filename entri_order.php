...
?>
    ...
    <body>
      ...
      <!--Header-part-->
      <div id="header">
        <h1><a href="entri_order.php">MENU</a></h1>
      </div>
      <!--close-Header-part-->
      ...
      <div id="sidebar"><a href="entri_order.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>Entri Order</span></a>
        <ul>
          ...
          ?>
            ...
            <li> <a href="entri_referensi.php"><i class="icon icon-tasks"></i> <span>Tambah menu</span></a> </li>
            <li class="active"> <a href="entri_order.php"><i class="icon icon-shopping-cart"></i> <span>Pesanan</span></a> </li>
            <li> <a href="entri_transaksi.php"><i class="icon icon-inbox"></i> <span>Transaksi</span></a> </li>
            <li> <a href="generate_laporan.php"><i class="icon icon-print"></i> <span>Laporan</span></a> </li>
          ...
          ?>
            <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li class="active"> <a href="entri_order.php"><i class="icon icon-shopping-cart"></i> <span>Lihat Menu</span></a> </li>
            <li> <a href="logout.php"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
          <?php
          }
          ?>
      ...
      <div id="content">
        ...
        <div id="content-header">
          <div id="breadcrumb"> <a href="entri_order.php" title="Go to here" class="tip-bottom"><i class="icon icon-tasks"></i> MENU</a></div>
        </div>
        <!--End-breadcrumbs-->
                  ...
                  <div class="widget-box span12">
                    ...
                    <div class="widget-content">
                      <div class="alert alert-info alert-block">
                        ...
                        Silahkan tunggu pesanan tiba di meja saudara. Apabila Sudah selesai , silahkan lakukan proses pembayaran di kasir !
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="row-fluid">
        <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy;<a href="#"> TKP TERAS KOPI</a> </div>
      </div>
